...
- (void) startNextRequest
{
	...
	else
	{
		...
		[self.eventLabels removeObjectAtIndex:0];
       		...
       		NSDictionary *query = @{ @"video_id": self.videoIdentifier, @"hl": self.languageIdentifier, @"el": eventLabel, @"ps": @"default", @"html5" : @"1", @"eurl": [@"https://youtube.googleapis.com/v/" stringByAppendingString:self.videoIdentifier],@"c": @"TVHTML5", @"cver": @"6.20180913"};		NSString *queryString = XCDQueryStringWithDictionary(query);
